...
const activeLeads = [
  { id: 1, name: "Sarah Johnson", company: "TechCorp", status: "qualifying", channel: "voice", time: "2m ago" },
  { id: 2, name: "Mike Chen", company: "StartupXYZ", status: "contacted", channel: "chat", time: "5m ago" },
  { id: 3, name: "Emily Davis", company: "Enterprise Co", status: "new", channel: "email", time: "8m ago" },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Monitor your inbound lead performance</p>
      </div>
