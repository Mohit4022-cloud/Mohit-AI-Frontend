...
export const metadata: Metadata = {
  title: 'Small Business Solutions - Mohit AI',
  ...
  return (
            ...
            &lt;div className="grid grid-cols-1 lg:grid-cols-2 gap-16"&gt;
                &lt;div&gt;
                    &lt;h1 className="text-5xl font-bold text-white leading-tight mb-8"&gt;
                        Grow Your Small Business with AI-Powered Sales
                    &lt;/h1&gt;
                    &lt;p className="text-xl text-gray-300 mb-12"&gt;
                        Get an AI sales assistant that works 24/7 to find leads, make calls, and book meetings - at a price that works for small businesses.
                    &lt;/p&gt;
                    ...
                    &lt;div className="flex items-center gap-8 text-sm text-gray-300"&gt;
                        ...
                        &lt;/div&gt;
                        &lt;div className="flex items-center gap-2"&gt;
                            &lt;span className="font-semibold"&gt;No&lt;/span&gt; Credit Card
                        &lt;/div&gt;
                        &lt;div className="flex items-center gap-2"&gt;
                ...
                &lt;div className="lg:mt-0 mt-12"&gt;
                    &lt;div className="bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-800"&gt;
                        &lt;h3 className="text-2xl font-bold text-white mb-8"&gt;Perfect for Small Businesses&lt;/h3&gt;
                        &lt;ul className="space-y-6"&gt;
                            &lt;li className="flex items-start space-x-4"&gt;
                                ...
                                &lt;div&gt;
                                    ...
                                    &lt;p className="text-gray-300"&gt;Plans starting at just $99/month with no long-term contracts&lt;/p&gt;
                                &lt;/div&gt;
                            &lt;/li&gt;
                            &lt;li className="flex items-start space-x-4"&gt;
                                &lt;div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-primary flex items-center justify-center text-white"&gt;
                                ...
                                &lt;div&gt;
                                    ...
                                    &lt;p className="text-gray-300"&gt;Get started in minutes with our guided onboarding process&lt;/p&gt;
                                &lt;/div&gt;
                            &lt;/li&gt;
                            &lt;li className="flex items-start space-x-4"&gt;
                                &lt;div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-primary flex items-center justify-center text-white"&gt;
                                ...
                                &lt;/div&gt;
                                &lt;div&gt;
                                    &lt;h4 className="text-lg font-semibold text-white mb-2"&gt;Full Feature Set&lt;/h4&gt;
                                    &lt;p className="text-gray-300"&gt;Access to all core features without enterprise pricing&lt;/p&gt;
                                &lt;/div&gt;
                            &lt;/li&gt;
                        &lt;/ul&gt;
                    &lt;/div&gt;
    ...
    &lt;section className="py-20 bg-gray-800"&gt;
        &lt;div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"&gt;
            &lt;div className="text-center max-w-3xl mx-auto mb-16"&gt;
                &lt;h2 className="text-4xl font-bold text-white mb-6"&gt;Built for Small Business Success&lt;/h2&gt;
                &lt;p className="text-xl text-gray-300"&gt;Everything you need to grow your sales without growing your team&lt;/p&gt;
            &lt;/div&gt;
            &lt;div className="grid grid-cols-1 md:grid-cols-3 gap-8"&gt;
                &lt;div className="bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:shadow-xl transition-all duration-300"&gt;
                    ...
                    &lt;p className="text-gray-300"&gt;AI finds and engages perfect-fit prospects for your business, building a steady pipeline of opportunities.&lt;/p&gt;
                &lt;/div&gt;
                &lt;div className="bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:shadow-xl transition-all duration-300"&gt;
                    &lt;h3 className="text-2xl font-bold text-white mb-4"&gt;Automated Outreach&lt;/h3&gt;
                    &lt;p className="text-gray-300"&gt;Multi-channel outreach campaigns that run 24/7, engaging prospects through calls, emails, and social.&lt;/p&gt;
                &lt;/div&gt;
                &lt;div className="bg-gray-900 p-8 rounded-2xl border border-gray-800 hover:shadow-xl transition-all duration-300"&gt;
                    &lt;h3 className="text-2xl font-bold text-white mb-4"&gt;Meeting Booking&lt;/h3&gt;
                    &lt;p className="text-gray-300"&gt;AI qualifies leads and books meetings directly into your calendar when prospects are ready to talk.&lt;/p&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/section&gt;
    ...
    &lt;section className="py-20 bg-gray-900"&gt;
        &lt;div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"&gt;
            &lt;div className="grid grid-cols-1 lg:grid-cols-2 gap-16"&gt;
                &lt;div&gt;
                    &lt;h2 className="text-4xl font-bold text-white mb-8"&gt;Why Small Businesses Love Mohit AI&lt;/h2&gt;
                    &lt;div className="space-y-8"&gt;
                        &lt;div className="flex items-start space-x-4"&gt;
                            ...
                            &lt;/div&gt;
                            &lt;div&gt;
                                &lt;h3 className="text-lg font-semibold text-white mb-2"&gt;Cost-Effective Growth&lt;/h3&gt;
                                &lt;p className="text-gray-300"&gt;Get the power of a full sales team at a fraction of the cost. No need to hire additional SDRs.&lt;/p&gt;
                            &lt;/div&gt;
                        &lt;/div&gt;
                        &lt;div className="flex items-start space-x-4"&gt;
                            &lt;div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-primary flex items-center justify-center text-white font-bold"&gt;
                            ...
                            &lt;/div&gt;
                            &lt;div&gt;
                                &lt;h3 className="text-lg font-semibold text-white mb-2"&gt;Time-Saving Automation&lt;/h3&gt;
                                &lt;p className="text-gray-300"&gt;Focus on closing deals while AI handles prospecting, follow-ups, and meeting scheduling.&lt;/p&gt;
                            &lt;/div&gt;
                        &lt;/div&gt;
                        &lt;div className="flex items-start space-x-4"&gt;
                            &lt;div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-primary flex items-center justify-center text-white font-bold"&gt;
                            ...
                            &lt;/div&gt;
                            &lt;div&gt;
                                &lt;h3 className="text-lg font-semibold text-white mb-2"&gt;Scalable Results&lt;/h3&gt;
                                &lt;p className="text-gray-300"&gt;Grow your pipeline consistently without adding overhead or complexity to your business.&lt;/p&gt;
                            &lt;/div&gt;
                        &lt;/div&gt;
                    &lt;/div&gt;
                &lt;/div&gt;
    ...
    &lt;section className="py-20 bg-gradient-to-r from-primary to-accent text-white"&gt;
        &lt;div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"&gt;
            ...
            &lt;p className="text-xl text-gray-300 mb-12"&gt;Join hundreds of small businesses using Mohit AI to scale their sales&lt;/p&gt;
