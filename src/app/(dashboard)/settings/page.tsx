      ...
      >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        {provider.lastSync &&
                          ` • Last sync ${format(new Date(provider.lastSync), "MMM d, h:mm a")}`}
                      </p>
                    </div>
                  </div>
        ...
        <TabsContent value="whitelabel" className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              White-label features allow you to customize the platform with your
              brand identity. Changes will be reflected across all user
              interfaces.
            </AlertDescription>
          </Alert>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Customize the platform appearance with your brand
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="space-y-3">
                  {auditLogs
                    .filter((log) => {
                      if (
                        auditFilter.user &&
                        !log.user.includes(auditFilter.user)
                      )
                        return false;
                      if (
                        auditFilter.action &&
                        !log.action.includes(auditFilter.action)
                      )
                        return false;
                      return true;
                    })
                    .map((log) => (
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          >
                            <span
                              className={getActionColor(log.action, log.status)}
                            >
                            ...
                            {log.details && (
                              <div className="mt-2 text-xs text-muted-foreground">
                                {log.action.includes("update") &&
                                  log.details.fields && (
                                    <span>
                                      Modified: {log.details.fields.join(", ")}
                                    </span>
                                  )}
          ...
          {selectedProvider && (
            <div className="space-y-4 py-4">
              <Alert>
                <Info className="h-4 w-4" />
                <AlertDescription>
                  Configure your {selectedProvider.name}{" "}
                  {selectedProvider.type.toUpperCase()} settings below.
                  You&apos;ll need administrator access to your identity
                  provider.
                </AlertDescription>
              </Alert>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {["email", "firstName", "lastName", "department", "role"].map(
                    (attr) => (
