...
export function CallControls({ callId }: CallControlsProps) {
  const { activeCalls, takeOverCall, pauseAI, resumeAI, endCall } =
    useAICallStore();
  ...
  const handleCoachModeToggle = (enabled: boolean) => {
    ...
    if (enabled) {
      toast({
        ...
        description:
          "You can now whisper to the agent without the customer hearing",
      });
    }
  };
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          <Button variant="secondary" className="h-12" disabled>
        ...
        <div className="space-y-3 pt-2 border-t">
          ...
          <div className="flex gap-2">
            <Popover
              open={isAdjustingBehavior}
              onOpenChange={setIsAdjustingBehavior}
            >
