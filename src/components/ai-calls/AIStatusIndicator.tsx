      ...
      <div className="flex flex-col items-center gap-2">
        <div className={cn(
          ...
          <div className="flex items-end gap-0.5 h-4">
            <div className="w-0.5 bg-white rounded-full animate-sound-wave" style={{ height: '60%' }} />
            <div className="w-0.5 bg-white rounded-full animate-sound-wave-delayed" style={{ height: '100%' }} />
            <div className="w-0.5 bg-white rounded-full animate-sound-wave [animation-delay:0.2s]" style={{ height: '80%' }} />
            <div className="w-0.5 bg-white rounded-full animate-sound-wave-delayed [animation-delay:0.3s]" style={{ height: '90%' }} />
            <div className="w-0.5 bg-white rounded-full animate-sound-wave [animation-delay:0.4s]" style={{ height: '70%' }} />
          </div>
        </div>
        {showLabel && (
