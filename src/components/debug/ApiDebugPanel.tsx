    ...
    try {
      ...
      const options: RequestInit = {
        ...
        headers: {
          ...
          ...(test.requiresAuth && token ? { Authorization: `Bearer ${token}` } : {}),
        },
      }
    ...
    <Card className="w-full">
      <CardHeader>
        ...
        <div className="text-sm text-gray-600 space-y-1">
          ...
          <p>Auth Token: {token ? `${token.substring(0, 20)}...` : 'Not authenticated'}</p>
        </div>
      </CardHeader>
      <CardContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      disabled={loading[test.name] || (test.requiresAuth && !token)}
                    >
                      Test
                    </Button>
                  </div>
