...
const envSchema = z.object({
  ...
  // Feature flags
  ENABLE_VOICE_CALLS: z.string().transform(v => v === 'true').default('true'),
  ENABLE_SMS: z.string().transform(v => v === 'true').default('true'),
  ENABLE_EMAIL: z.string().transform(v => v === 'true').default('true'),
  ENABLE_AI_COACHING: z.string().transform(v => v === 'true').default('true'),
  ENABLE_DEBUG_ENDPOINTS: z.string().transform(v => v === 'true').default('false'),
});
