...
export function validateServerEnv(): ServerEnv {
  try {
    ...
    if (
      ...
      console.warn(
        "Using placeholder values for missing environment variables during build",
      );
      return {
        ...
        JWT_SECRET:
          process.env.JWT_SECRET || "build-placeholder-jwt-secret-32-chars",
        JWT_REFRESH_SECRET:
          process.env.JWT_REFRESH_SECRET ||
          "build-placeholder-refresh-secret-32ch",
        JWT_EXPIRES_IN: "15m",
