...
function validateEnv() {
  try {
    ...
    if (
      ...
      console.warn(
        "Using default values for missing environment variables during build",
      );
      return {
        ...
        JWT_SECRET:
          process.env.JWT_SECRET || "build-time-placeholder-jwt-secret",
        JWT_REFRESH_SECRET:
          process.env.JWT_REFRESH_SECRET || "build-time-placeholder-refresh",
